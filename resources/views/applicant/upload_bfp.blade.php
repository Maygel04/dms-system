...
@section('title', 'BFP Requirements')
    ...
    @if(!$uploaded || $needsReupload)
        ...
        <div class="card card-outline card-primary shadow">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('applicant.upload_bfp.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            ...
                            {{ $needsReupload ? 'Re-upload BFP Requirements' : 'Submit BFP Requirements' }}
                        </button>
                    </div>
                </form>
            </div>
