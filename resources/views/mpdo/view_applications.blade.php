...
@if($hasRemark)
<div class="card shadow-sm mb-4">
<div class="card-header bg-warning">📝 MPDO Latest Remark</div>
<div class="card-body">
...
{{-- FINAL VERIFY --}}
<form method="POST" action="{{ route('mpdo.verify', $application->id) }}" class="mt-3">
@csrf
...
{{-- REMARK --}}
<form method="POST" action="{{ route('mpdo.saveRemark') }}" class="mt-3">
@csrf
<input type="hidden" name="application_id" value="{{ $application->id }}">
