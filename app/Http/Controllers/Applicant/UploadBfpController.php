...
class UploadBfpController extends Controller
{
    ...
    public function index(Request $request)
{
    ...
    if(!$app){
        return view('applicant.upload_bfp',[
            'app'=>null,
            'uploaded'=>false,
            'remark'=>null,
            'verified'=>false,
...
public function store(Request $request)
{
    ...
    if (
       !$request->hasFile('architectural_plan') &&
        ...
        !$request->hasFile('fire_safety_clearance')&&
        !$request->hasFile('fire_protection_plan') &&
        !$request->hasFile('fire_alarm_layout')
    ){
    ...
    $request->validate([
        ...
        'fire_safety_clearance' => 'file|mimes:pdf,dwg,dxf|max:25600',
        'fire_protection_plan' => 'file|mimes:pdf,dwg,dxf|max:25600',
        'fire_alarm_layout' => 'file|mimes:pdf,dwg,dxf|max:25600'
...
$path = $file->storeAs('bfp_docs', $filename, 'public');
...
DB::table('documents')->insert([
    ...
    return redirect()->back()->with('success','BFP documents submitted successfully.');
}
