...
<td>
<a href="<?php echo e(url('/mpdo/applications?app_id='.$a->id)); ?>"
...
<td>
    ...
    <?php echo e($f->file_name); ?><br>

    <?php if(isset($f->is_old) && $f->is_old == 1): ?>
        <span class="badge bg-warning text-dark mt-1">OLD FILE</span>
    <?php endif; ?>

    <?php if(isset($f->uploaded_by_admin) && $f->uploaded_by_admin == 1): ?>
...
<button type="button"
    ...
    data-file="<?php echo e(asset('storage/mpdo_docs/'.$f->file_name)); ?>">
    👁 View File
</button>
...
<form method="POST" action="<?php echo e(route('mpdo.saveRemark')); ?>">
...
<small><?php echo e($r->created_at); ?></small>
...
<a href="<?php echo e(url('/mpdo/receipt/'.$application->id)); ?>"
...
<form method="POST" action="<?php echo e(route('mpdo.saveAssessment')); ?>">
<?php echo csrf_field(); ?>
...
<form method="POST" action="<?php echo e(route('mpdo.verify',$application->id)); ?>">
<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bps-laravel\resources\views/mpdo/applications.blade.php ENDPATH**/ ?>