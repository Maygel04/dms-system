...
<?php $__env->startSection('title', 'MPDO Requirements'); ?>
    ...
    <?php if(!$uploaded || $remark): ?>
        ...
        <div class="card card-outline card-primary shadow">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('applicant.upload_mpdo.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            ...
                            <?php echo e(!empty($remark) ? 'Re-upload MPDO Requirements' : 'Submit MPDO Requirements'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bps-laravel\resources\views/applicant/upload_mpdo.blade.php ENDPATH**/ ?>