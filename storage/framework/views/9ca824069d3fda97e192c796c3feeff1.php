...
<td>
    <?php if($a->meo_endorsed == 1): ?>

        <span class="badge bg-primary">
            ENDORSED
        </span>

    <?php elseif($a->meo_status == 'assessed'): ?>

        <span class="badge bg-info">
            ASSESSED
        </span>

    <?php elseif($a->meo_status == 'verified'): ?>

        <span class="badge bg-success">
            VERIFIED
        </span>

    <?php elseif($a->meo_status == 'pending'): ?>
    ...
    <?php else: ?>
        ...
        <span class="badge bg-secondary">
            <?php echo e(strtoupper($a->meo_status ?? 'N/A')); ?>
...
<td>
<a href="<?php echo e(url('/meo/applications?app_id='.$a->id)); ?>"
...
<td>
    <button type="button"
        ...
        data-file="<?php echo e(asset('storage/meo_docs/'.$f->file_name)); ?>">
        👁 View File
    </button>
</td>
...
<form method="POST" action="<?php echo e(route('meo.saveRemark')); ?>">
...
<a href="<?php echo e(url('/meo/receipt/'.$application->id)); ?>"
...
<form method="POST" action="<?php echo e(route('meo.issue.endorsement')); ?>">
<?php echo csrf_field(); ?>
<input type="hidden" name="application_id" value="<?php echo e($application->id); ?>">
...
<form method="POST" action="<?php echo e(route('meo.mark.paid')); ?>">
<?php echo csrf_field(); ?>
<input type="hidden" name="application_id" value="<?php echo e($application->id); ?>">
...
<form method="POST" action="<?php echo e(route('meo.saveAssessment')); ?>">
<?php echo csrf_field(); ?>
...
<form method="POST" action="<?php echo e(route('meo.verify',$application->id)); ?>">
<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bps-laravel\resources\views/meo/applications.blade.php ENDPATH**/ ?>