...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <?php if(config('adminlte.usermenu_image')): ?>
            <img src="<?php echo e(Auth::user()->adminlte_image()); ?>"
                 ...
                 style="width:34px;height:34px;object-fit:cover;border-radius:50%;display:inline-block;vertical-align:middle;">
        <?php endif; ?>
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
            <?php if($profile_url): ?>
                <a href="<?php echo e(route('profile.edit')); ?>" class="nav-link btn btn-default btn-flat d-inline-block">
...
</li><?php /**PATH C:\laragon\www\bps-laravel\vendor\jeroennoten\laravel-adminlte\src/../resources/views/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>