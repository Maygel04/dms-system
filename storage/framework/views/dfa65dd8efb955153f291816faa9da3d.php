...
<?php $__env->startSection('title', 'MEO Requirements'); ?>
    ...
    <?php if(!$uploaded || $needsReupload): ?>
        ...
        <div class="card card-outline card-primary shadow">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('applicant.upload_meo.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            ...
                            <?php echo e($needsReupload ? 'Re-upload MEO Requirements' : 'Submit MEO Requirements'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bps-laravel\resources\views/applicant/upload_meo.blade.php ENDPATH**/ ?>