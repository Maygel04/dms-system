...
<div><b>Contact:</b><br><?php echo e($user->contact_number); ?></div>
<div><b>Address:</b><br><?php echo e($user->address); ?></div>
<div><b>Gender:</b><br><?php echo e($user->gender); ?></div>
<div><b>Occupation:</b><br><?php echo e($user->occupation); ?></div>
...
<a href="<?php echo e(route('applicant.upload_mpdo')); ?>" style="
background:#dc2626;
color:#fff;
padding:10px 22px;
border-radius:6px;
...
<?php elseif($mpdoStatus == 'assessed'): ?>
...
<?php elseif($mpdoStatus == 'verified' && $meoRemark): ?>

<a href="<?php echo e(route('applicant.upload_meo')); ?>" style="
background:#dc2626;
color:#fff;
padding:10px 22px;
border-radius:6px;
...
<?php elseif($mpdoStatus == 'verified' && $meoDocs == 0): ?>
...
<?php elseif($meoDocs > 0 && $meoStatus == 'pending'): ?>
...
<?php elseif($meoStatus == 'verified' && $meoEndorsed == 0): ?>
...
<?php elseif($meoEndorsed == 1 && $meoPaid == 0): ?>
...
<?php elseif($meoPaid == 1 && $bfpRemark): ?>

<a href="<?php echo e(route('applicant.upload_bfp')); ?>" style="
background:#dc2626;
color:#fff;
padding:10px 22px;
border-radius:6px;
...
<?php elseif($meoPaid == 1 && $bfpDocs == 0): ?>
...
<?php elseif($bfpIssued == 1 && $bfpPaid == 0): ?>
...
<?php elseif($bfpStatus == 'verified' && $bfpIssued == 0): ?>
...
<?php elseif($bfpDocs > 0 && $bfpStatus == 'pending'): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bps-laravel\resources\views/applicant/dashboard.blade.php ENDPATH**/ ?>